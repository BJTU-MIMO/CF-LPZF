...
for n = 1:nbrOfSetups
   ...
   [gainOverNoisedB,R,pilotIndex,D_orig] = generateSetup_new(L,K,N,tau_p,1);
    ...
    p_uplink = fractionalPowerControl_1(beta_matrix,p_max,K);
    p_regu = p_uplink;
    ...
    [S,W,Z,M_matrix,E_S_temp, tau_S_l] = functionUEgrouping_ceshi(L,K,beta_matrix,pilotIndex,tau_p);
    mean_tau_S_l = mean(tau_S_l);
    final_mean_tau_S_l = final_mean_tau_S_l + mean_tau_S_l/nbrOfSetups;
